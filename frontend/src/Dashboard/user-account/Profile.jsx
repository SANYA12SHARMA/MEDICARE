    ...
    <div className='mt-10'>
       ...
       <div className='mb-5'>
        ...
        <div className='mb-5'>
          ...
          onChange={handleInputChange}
          className='w-full pr-4 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placeholder:text-textColor rounded-md cursor-pointer' aria-readonly
          readOnly
          />
        </div>
        <div className='mb-5'>
        ...
        <div className='mb-5 flex items-center justify-between'>
          ...
          <div className='mt-7'>
          <button 
          disabled={loading && true} type="submit" className='w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg px-4 py-3'>{loading ? (<HashLoader size={35} color="#ffffff"/>) :'Update'}</button>
        </div>
